...
import com.william.model.GroupExample.Criteria;
import com.william.model.GroupExample.Criterion;
...
public class GroupSqlProvider {
    ...
    public String insertSelective(Group record) {
        ...
        if (record.getIsAdmin() != null) {
            VALUES("is_admin", "#{isAdmin,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIsAdmin() != null) {
            SET("is_admin = #{record.isAdmin,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Group record) {
        ...
        if (record.getIsAdmin() != null) {
            SET("is_admin = #{isAdmin,jdbcType=TINYINT}");
        }
     ...
     * @mbggenerated Fri Mar 17 15:26:19 CST 2017
     */
    protected void applyWhere(GroupExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
